...
QT_MOC_LITERAL(3, 16, 8), // "joinRail"
QT_MOC_LITERAL(4, 25, 7) // "outRail"

    },
    "Trem\0updateGUI\0\0joinRail\0outRail"
};
...
void Trem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Trem::joinRail)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Trem::outRail)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void Trem::joinRail(int _t1, int _t2)
{
